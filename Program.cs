...
namespace DIO.Bank
{
    class Program
    {
        ...
        {
            Console.Write("Digite o número do índice da conta na lista para a qual quer depositar: ");
        ...
        {
            Console.Write("Digite o número do índice da conta na lista para a qual quer sacar: ");
            int indiceConta = int.Parse(Console.ReadLine());
